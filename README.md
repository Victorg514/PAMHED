...
This project explores the efficacy of personalized, behavior-based machine learning models for detecting mental health conditions (depression, anxiety, bipolar disorder) from Twitter/X and Reddit user data. The core hypothesis is that a user's deviation from their unique behavioral baseline is a more robust signal than post content alone.
...
Final paper in progress. See 396 Progress report 3.pdf for more details.
